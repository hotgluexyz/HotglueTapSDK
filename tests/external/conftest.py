...
def gitlab_config() -> Optional[dict]:
    ...
    path = Path("hotglue_singer_sdk/tests/external/.secrets/gitlab-config.json")
...
def ga_config() -> Optional[dict]:
    ...
    config: Optional[dict] = None
    path = Path("hotglue_singer_sdk/tests/external/.secrets/google-analytics-config.json")
