...
from hotglue_tap_sdk.exceptions import InvalidStreamSortException, MaxRecordsLimitException
from hotglue_tap_sdk.helpers._catalog import pop_deselected_record_properties
...
from hotglue_tap_sdk.helpers._singer import (
    Catalog,
    CatalogEntry,
    MetadataMapping,
    SelectionMask,
...
from hotglue_tap_sdk.helpers._typing import conform_record_data_types, is_datetime_type
from hotglue_tap_sdk.helpers._util import utc_now
from hotglue_tap_sdk.mapper import RemoveRecordTransform, SameRecordTransform, StreamMap
...
class Stream(metaclass=abc.ABCMeta):
    ...
    def get_starting_replication_key_value(
        ...
        :meth:`~hotglue_tap_sdk.Stream.get_starting_timestamp()`
    ...
    def get_starting_timestamp(
        ...
        :meth:`~hotglue_tap_sdk.Stream.get_starting_replication_key_value()`
    ...
    def tap_state(self) -> dict:
        ...
        replication key values using :meth:`~hotglue_tap_sdk.Stream.get_starting_timestamp()`
        for timestamp keys, or
        :meth:`~hotglue_tap_sdk.Stream.get_starting_replication_key_value()` for
        non-timestamp keys.
    ...
    def get_context_state(self, context: Optional[dict]) -> dict:
        ...
        :meth:`~hotglue_tap_sdk.Stream.get_starting_timestamp()` for timestamp keys, or
        :meth:`~hotglue_tap_sdk.Stream.get_starting_replication_key_value()` for
        non-timestamp keys.

        Partition level may be overridden by
        :attr:`~hotglue_tap_sdk.Stream.state_partitioning_keys` if set.
