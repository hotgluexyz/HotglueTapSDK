...
from hotglue_tap_sdk.cli import common_options
from hotglue_tap_sdk.exceptions import RecordsWitoutSchemaException
from hotglue_tap_sdk.helpers._classproperty import classproperty
from hotglue_tap_sdk.helpers._compat import final
from hotglue_tap_sdk.helpers.capabilities import CapabilitiesEnum, PluginCapabilities
from hotglue_tap_sdk.io_base import SingerMessageType, SingerReader
from hotglue_tap_sdk.mapper import PluginMapper
from hotglue_tap_sdk.plugin_base import PluginBase
from hotglue_tap_sdk.sinks import Sink, BatchSink
...
class Target(PluginBase, SingerReader, metaclass=abc.ABCMeta):
    ...
    def get_sink(
        ...
        *,
        ...
        Raises :class:`hotglue_tap_sdk.exceptions.RecordsWitoutSchemaException` if sink does
    ...
    def get_sink_class(self, stream_name: str) -> Type[Sink]:
        ...
        Raises:
            ValueError: If no :class:`hotglue_tap_sdk.sinks.Sink` class is defined.
    ...
    def drain_all(self, is_endofpipe: bool = False) -> None:
        ...
        Args:
            is_endofpipe: This is passed by the
                          :meth:`~hotglue_tap_sdk.Sink._process_endofpipe()` which
